...
export class ReportesService {
  ...
  async generateTxtReport(fincaId: number, fechaDesde: string, fechaHasta: string): Promise<string> {
    // Buscar registros de labor en la base de datos
    const registros = await this.registroLaborRepository.createQueryBuilder('registro')
